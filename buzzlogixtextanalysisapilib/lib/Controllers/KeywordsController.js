...
var KeywordsController = {
     ...
     * @return {mixed}
     */
    createReturnEnglishKeywordsTextPlain : function(body, callback){
     ...
     * @return {mixed}
     */
    createReturnEnglishKeywordsMultipartFormData : function(text, callback){
     ...
     * @return {mixed}
     */
    createReturnEnglishKeywordsXWwwFormUrlencoded : function(text, callback){
