...
var TwittersentimentController = {
     ...
     * @return {mixed}
     */
    createReturnEnglishTwitterSentiment : function(body, callback){
     ...
     * @return {mixed}
     */
    createReturnEnglishTwitterSentimentForm : function(body, callback){

        //prepare query string for API call;
        var baseUri = configuration.BASEURI;
        
        var queryBuilder = baseUri + "/twittersentiment/form";
